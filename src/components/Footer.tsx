...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-zinc-200 bg-zinc-50 dark:border-zinc-800 dark:bg-[#0d0d0d] transition-colors duration-300">
      <div className="mx-auto max-w-6xl px-6 py-16">
        <div className="grid gap-12 sm:grid-cols-3">
          {/* Brand */}
          <div>
            <div className="mb-4 flex items-center gap-2">
              <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-[#a855f7] text-sm font-extrabold text-white">
                FP
              </span>
            ...
            <ul className="space-y-2.5 text-sm">
              <li>
                <a
                  ...
                  className="transition text-zinc-600 dark:text-zinc-500 hover:text-[#a855f7]"
                >
