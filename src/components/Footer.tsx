...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-zinc-200 bg-zinc-50 dark:border-zinc-800 dark:bg-[#060d18] transition-colors duration-300">
      <div className="mx-auto max-w-6xl px-6 py-16">
        <div className="grid gap-12 sm:grid-cols-3">
          ...
          <div>
            <div className="mb-4 flex items-center gap-2.5">
              <Image
                ...
                width={32}
                height={32}
                className="h-8 w-8 rounded-lg object-cover ring-1 ring-cyan-400/30 shadow-[0_0_16px_rgba(0,212,255,0.2)]"
              />
              <span className="text-lg font-bold text-foreground">FPH Solutions</span>
            </div>
            <p className="text-sm leading-relaxed text-zinc-600 dark:text-zinc-500">
              Solutions logicielles sur mesure. Next.js, React, TypeScript.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm text-zinc-600 dark:text-zinc-500">
              <li><Link href="/" className="transition hover:text-[#00d4ff]">Accueil</Link></li>
            ...
            <ul className="space-y-2.5 text-sm">
              <li>
                <a
                  ...
                  className="transition text-zinc-600 dark:text-zinc-500 hover:text-[#00d4ff]"
                >
              ...
              <li>
                <a
                  href="https://github.com/FPH-DEV89"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 text-zinc-600 dark:text-zinc-500 transition hover:text-[#00d4ff]"
                >
        ...
        <div className="mt-12 border-t border-zinc-200 dark:border-zinc-800/50 pt-8 text-center text-xs text-zinc-500 dark:text-zinc-600">
          ...
          <p className="mt-1.5 space-x-3">
            <Link href="/mentions-legales" className="hover:text-[#00d4ff] hover:underline transition">Mentions légales</Link>
            <span>•</span>
            <Link href="/politique-de-confidentialite" className="hover:text-[#00d4ff] hover:underline transition">Politique de confidentialité</Link>
            <span>•</span>
            <Link href="/politique-de-cookies" className="hover:text-[#00d4ff] hover:underline transition">Politique de cookies</Link>
            <span>•</span>
            <Link href="/cgu" className="hover:text-[#00d4ff] hover:underline transition">CGU</Link>
          </p>
